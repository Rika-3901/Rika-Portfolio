...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-center !leading-[1.5]"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <p className="text-lg sm:text-xl font-medium font-playfair">
      ...
      >
        <Link
          href="mailto:rikadoubleyou@gmail.com"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/rika-008668212/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Rika-3901"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
